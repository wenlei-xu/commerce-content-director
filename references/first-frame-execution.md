...
3. Record `executor=gpt_image_2_5`, `model=gpt-image-2.5`, `size=1152x2048`, `quality=high`, and `format=png` in `runs/<run_id>/planning/content-system-config-snapshot.json`, `runs/<run_id>/planning/execution-plan.json`, and the compiled prompt bundle.
