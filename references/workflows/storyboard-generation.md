...
1. Fresh-read the task, product facts and assets, subject identity, configuration snapshot, script, language, and mode. Build one `product_asset_plan` per raw segment from actual shot risk.
