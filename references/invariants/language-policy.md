...
- Copy the exact lock into the Markdown creation workbook metadata and the Feishu script field `目标口播语言`. Fresh-read the workbook and verify both before first-frame or final-video work.
